...
<body >
    ...
    <h1>WELCOME TO AFFINITY SOFTWARE</h1>
    <h2>Hire the World's Finest AI Freelance Talent</h2>
    <h2>PRODUCTS</h2>
    <a href="sign.html">
        <input type="button" value="JOIN US" class="join">
    </a>  
    
    <h3>Highly selective network of the world's top freelance talent in machine learning,computer vision,NLP and AI Research</h3>
...
<body>
    ...
    <div class="photos">
    <img src="photo.jpg" height="200" width="180">
    <img src="photo1.jpeg" height="200" width="200">
    <img src="photo2.jpeg" height="200" width="200">
    <img src="photo3.jpeg" height="200" width="200">
    <img src="photo4.jpeg" height="200" width="200">
    <img src="photo5.jpeg" height="200" width="200">
    <img src="photo6.jpeg" height="200" width="200">
</div>
<div CLASS="names">
    <P>    MALENI </P>    
    <P style="margin-left:-20;"> MR JOSEPH VIJAY</P>    
    <P>  MR DULQUER SALMAAN</P>    
    <P> MR CHAITANYA </P>    
    <P>MR VIJAYDEVARKONDA</P>    
    <P> MR SIVA</P>    
    <P>MR VIKRAM</P>    
</div>
<DIV class="position">
...
<body>
    ...
    <div class="form">
        <p align="center">JOIN THE FAMILY OF AFFINITY SOFTWARE</p>
...
<body>
    ...
    <div class="company">
       ...
       <p> <b >Address</b></p>
        <p >28,52nd Street ,1st main road</p>
        <p >MMDA,Mathur</p>
        <p >Chennai-600068</p>
        <b >Email:</b>
        <p >maleni9802@gmail.com</p>
        <b >Phone</b>
        <p >7305361388</p>
    </center>
    </div>
